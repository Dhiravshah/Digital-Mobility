...
public class PlayerBO {
    ...
    public List<Player> findPlayer(List<Player> playerList, String nationality) {
        return playerList.stream().filter(player -> player.getNationality().equals(nationality))
    ...
    public List<Player> findPlayer(List<Player> playerList, Double powerRating) {
        return playerList.stream().filter(player -> player.getPowerRating() == (powerRating))
                .collect(Collectors.toList());
    }
}